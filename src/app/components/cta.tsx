...
function Cta(props:any) {
  ...
  return (
    ...
    <div 
    onClick={()=>{}}
    className="flex flex-row  w-[220px] h-[50px] mt-[48px]  items-center justify-center text-center bg-[#BEF56E] rounded-tl-[10px] rounded-br-[10px] ">
      <span 
      className="font-right py-auto text-[16px] font-normal leading-[20px] w-full text-center uppercase text-[#141414] ">get started</span>
    </div>
