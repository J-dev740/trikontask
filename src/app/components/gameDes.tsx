...
const GameDescription:React.FC<props>=(props)=> {
  ...
  return (
          ...
          <div className="grid grid-cols-3 w-full md:w-[54%] h-fit flex-wrap grid-flow-row gap-x-[10px] gap-y-[12px]">
            ...
            className="flex w-full h-[335px] col-span-3 bg-center bg-cover bg-no-repeat rounded-[20px]"></div>
            <div 
            style={{backgroundImage:`url(/assets/${game?.gameimages[1]})`}}
            className="flex w-full h-[204px] col-span-1 bg-center bg-cover bg-no-repeat rounded-[20px] "></div>
            <div
          ...
          <div className="flex md:w-[46%]  w-full items-start justify-start flex-wrap h-fit font-Mont gap-[18px]">
            ...
            {/* play cta */}
            <div className="   hover:cursor-pointer flex flex-row items-center justify-center w-[130px] h-[50px] bg-[#BEF56E] text-[#141414] font-right font-normal text-[16px]  leading-[19px] text-center rounded-tl-[10px] rounded-br-[10px] ">
